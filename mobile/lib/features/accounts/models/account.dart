...
enum AccountType {
  ...
  @JsonValue('brokerage')
  brokerage,
  @JsonValue('ira_traditional')
  iraTraditional,
  @JsonValue('ira_roth')
  iraRoth,
  @JsonValue('retirement_401k')
  retirement401k,
  @JsonValue('retirement_403b')
  retirement403b,
  @JsonValue('hsa')
  hsa,
  @JsonValue('college_529')
  college529,
  @JsonValue('cash')
  cash,
  @JsonValue('mortgage')
  ...
  AccountGroup get group => switch (this) {
    ...
    AccountType.savings ||
    AccountType.cash => AccountGroup.banking,
  ...
  IconData get icon => switch (this) {
    ...
    AccountType.iraRoth => Icons.account_balance_wallet_outlined,
    AccountType.retirement401k ||
    AccountType.retirement403b => Icons.work_outline,
